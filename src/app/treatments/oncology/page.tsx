...
export const metadata: Metadata = {
  title: "Head, Neck & Facial (HNF) Oncology | AiHospitalERP",
  description:
    "Comprehensive head, neck, and facial oncology care at AiHospitalERP. Early detection, advanced surgical oncology, and holistic rehabilitation.",
  keywords: [
    "HNF oncology",
    ...
    <>
      ...
      <main className={styles.page}>
        ...
        <section className={styles.whyChooseSection}>
          <div className="container">
            <h2 className={styles.sectionTitle}>Why Choose AiHospitalERP for HNF Oncology?</h2>
        ...
        <CTASection
          ...
          description="Early detection can make a life-saving difference. Take the first step toward timely diagnosis and expert care at AiHospitalERP."
