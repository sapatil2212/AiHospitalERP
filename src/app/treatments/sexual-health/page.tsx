...
export const metadata: Metadata = {
  title: "Sexual Health & Wellness | AiHospitalERP",
  description:
    "Confidential, compassionate, and result-oriented sexual health care for men and women at AiHospitalERP. Advanced medical and regenerative therapies.",
  keywords: [
    "sexual health India",
    ...
    <>
      ...
      <main className={styles.page}>
        ...
        <section className={styles.whyChooseSection}>
          <div className="container">
            <h2 className={styles.sectionTitle}>Why Choose AiHospitalERP for Sexual Wellness?</h2>
