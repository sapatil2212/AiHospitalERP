            ...
            <div className={styles.heroContent}>
              ...
              >
                ...
                <p className={styles.heroDescription}>
                  At AiHospitalERP, we provide complete dental care using AI diagnostics, robotic precision, and advanced technology for safe, painless, long-lasting results.</p>
