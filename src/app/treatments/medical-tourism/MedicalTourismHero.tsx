          ...
          <div className={styles.heroContent}>
            ...
            >
              ...
              <p className={styles.heroDescription}>
                At AiHospitalERP, we offer a seamless medical tourism experience for international patients, combining advanced treatments, personalized care, and premium hospitality.
              </p>
