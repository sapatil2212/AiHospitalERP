          ...
          <div className={styles.heroContent}>
            ...
            >
              ...
              <p className={styles.heroDescription}>
                At AiHospitalERP, we offer comprehensive dermatology and aesthetic treatments designed to enhance skin health, restore confidence, and deliver natural, long-lasting results.
              </p>
