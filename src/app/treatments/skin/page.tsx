...
export const metadata: Metadata = {
  title: "AI Skin Treatment & Advanced Dermatology | AiHospitalERP",
  description:
    "Advanced AI-based skin treatments, laser therapy, and dermatology services at AiHospitalERP. Personalized care for acne, anti-aging, and skin rejuvenation.",
  keywords: [
    "AI skin treatment",
    "dermatology India",
    ...
    <>
      ...
      <main className={styles.page}>
        ...
        <section className={styles.whyChooseSection}>
          <div className="container">
            <h2 className={styles.sectionTitle}>Why Choose AiHospitalERP for Skin & Aesthetic Treatments?</h2>
        ...
        <CTASection
          ...
          description="Take the first step toward healthy, glowing, and youthful skin with expert care at AiHospitalERP. Experience advanced dermatology like never before."
