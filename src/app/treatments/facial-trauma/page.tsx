...
export const metadata: Metadata = {
  title: "Facial Trauma & Maxillofacial Surgery | AiHospitalERP",
  description:
    "Advanced emergency care for facial injuries, jaw fractures, and facial bone reconstruction at AiHospitalERP. Expert maxillofacial surgeons and 24/7 care.",
  keywords: [
    ...
    <>
      ...
      <main className={styles.page}>
        ...
        <section className={styles.whyChooseSection}>
          <div className="container">
            <h2 className={styles.sectionTitle}>Why Choose AiHospitalERP for Facial Trauma Care?</h2>
        ...
        <CTASection
          ...
          description="In case of facial trauma or emergency, timely care is crucial. Trust the experts at AiHospitalERP for rapid, safe, and effective treatment."
