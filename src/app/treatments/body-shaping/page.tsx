...
export const metadata: Metadata = {
  title: "Body Shaping & Contouring Center | AiHospitalERP",
  description:
    "Advanced non-surgical body contouring, fat reduction, and skin tightening at AiHospitalERP. Sculpt your body with precision and no downtime.",
  keywords: [
    "body shaping India",
    ...
    <>
      ...
      <main className={styles.page}>
        ...
        <section className={styles.whyChooseSection}>
          <div className="container">
            <h2 className={styles.sectionTitle}>Why Choose AiHospitalERP for Body Contouring?</h2>
