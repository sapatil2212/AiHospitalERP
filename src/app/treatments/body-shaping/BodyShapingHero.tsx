          ...
          <div className={styles.heroContent}>
            ...
            >
              ...
              <p className={styles.heroDescription}>
                At AiHospitalERP, we offer advanced body contouring and fat reduction treatments that help you achieve a toned, sculpted, and confident appearance—without surgery or downtime.
              </p>
