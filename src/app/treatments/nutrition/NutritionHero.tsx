          ...
          <div className={styles.heroContent}>
            ...
            >
              ...
              <p className={styles.heroDescription}>
                At AiHospitalERP, we believe that true wellness begins from within. Our Clinical Nutrition & Metabolic Wellness programs are designed to help you achieve sustainable weight management, improved metabolism, and overall health transformation.
              </p>
