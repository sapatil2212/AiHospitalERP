...
export const metadata: Metadata = {
  title: "Clinical Nutrition & Metabolic Wellness | AiHospitalERP",
  description:
    "Science-based nutrition and lifestyle care at AiHospitalERP. Personalized diet planning, weight management, and metabolic wellness for sustainable health transformation.",
  keywords: [
    ...
    <>
      ...
      <main className={styles.page}>
        ...
        <section className={styles.whyChooseSection}>
          <div className="container">
            <h2 className={styles.sectionTitle}>Why Choose AiHospitalERP for Clinical Nutrition?</h2>
