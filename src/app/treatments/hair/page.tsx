...
export const metadata: Metadata = {
  title: "AI Hair Restoration & Advanced Trichology | AiHospitalERP",
  description:
    "Advanced AI-based hair restoration, PRP therapy, and hair transplant services at AiHospitalERP. Personalized care for hair loss and scalp health.",
  keywords: [
    "AI hair restoration",
    "trichology India",
    ...
    <>
      ...
      <main className={styles.page}>
        ...
        <section className={styles.whyChooseSection}>
          <div className="container">
            <h2 className={styles.sectionTitle}>Why Choose AiHospitalERP for Hair Treatments?</h2>
        ...
        <CTASection
          ...
          description="Take the first step toward stronger, healthier, and fuller hair with expert care at AiHospitalERP. Start your hair restoration journey with confidence."
