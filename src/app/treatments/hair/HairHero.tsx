          ...
          <div className={styles.heroContent}>
            ...
            >
              ...
              <p className={styles.heroDescription}>
                At AiHospitalERP, we specialize in advanced hair restoration and scalp treatments using AI-based diagnostics, regenerative therapies, and modern transplant techniques.
              </p>
