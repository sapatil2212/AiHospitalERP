...
export const metadata: Metadata = {
  title: "Premium Aesthetic & Cosmetic Center | AiHospitalERP",
  description:
    "Luxury aesthetic care at AiHospitalERP. Subtle, elegant, and long-lasting results for facial rejuvenation, profile enhancement, and more.",
  keywords: [
    ...
    <>
      ...
      <main className={styles.page}>
        ...
        <section className={styles.whyChooseSection}>
          <div className="container">
            <h2 className={styles.sectionTitle}>Why Choose AiHospitalERP for Premium Aesthetics?</h2>
        ...
        <CTASection
          ...
          description="Enhance your natural beauty with luxury aesthetic treatments at AiHospitalERP. Experience the perfect blend of science and art."
