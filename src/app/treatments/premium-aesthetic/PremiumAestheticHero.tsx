          ...
          <div className={styles.heroContent}>
            ...
            >
              ...
              <p className={styles.heroDescription}>
                At AiHospitalERP, we offer a premium aesthetic experience where advanced medical science meets artistic precision. Our treatments enhance your natural features for subtle, elegant results.
              </p>
