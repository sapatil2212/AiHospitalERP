...
import {
  IndianRupee, TrendingUp, TrendingDown, FileText, CreditCard,
  Plus, Loader2, LogOut, X, Check, Printer,
  Save, Trash2, Pencil, BarChart3,
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        if (prof && prof.success) setProfile(prof.data);
      } catch {
        router.push("/login");
      } finally {
        setLoading(false);
