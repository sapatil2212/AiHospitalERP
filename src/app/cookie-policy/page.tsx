...
export const metadata: Metadata = {
  title: "Cookie Policy | AiHospitalERP",
  description:
    "Learn about how AiHospitalERP uses cookies and tracking technologies to improve your browsing experience and deliver personalized content.",
};
          ...
          <div className="container">
            <div className={styles.heroInner}>
              ...
              <p className={styles.heroSubtitle}>
                This Cookie Policy explains what cookies are, how AiHospitalERP uses them,
          ...
          <div className="container">
            <div className={styles.contentInner}>
              ...
              <div id="how-we-use" className={styles.section}>
                ...
                <p className={styles.sectionText}>
                  AiHospitalERP uses cookies for the following purposes:
                </p>
