    ...
    <table width="520" cellpadding="0" cellspacing="0" style="max-width:520px;width:100%;background:#ffffff;border-radius:14px;border:1px solid #e5e7eb;overflow:hidden;">
      ...
      <tr><td style="padding:28px 36px;">
        ...
        <p style="margin:0 0 20px;font-size:14px;color:#6b7280;line-height:1.65;">
          Thank you for requesting a demo of AiHospitalERP for <strong>${hospitalName}</strong>! We have received your request and our team will get back to you shortly to confirm your slot.
        </p>
      ...
      <tr><td style="padding:16px 36px 24px;border-top:1px solid #f3f4f6;text-align:center;">
        <p style="margin:0;font-size:11px;color:#d1d5db;">&copy; ${year} AiHospitalERP &middot; Automated confirmation.</p>
      </td></tr>
    </table>
  </td></tr>
</table>
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#f5f7fa;padding:40px 16px;">
  <tr><td align="center">
    <table width="520" cellpadding="0" cellspacing="0" style="max-width:520px;width:100%;background:#ffffff;border-radius:14px;border:1px solid #e5e7eb;overflow:hidden;">
      ...
      <tr><td style="padding:28px 36px;">
        <p style="margin:0 0 16px;font-size:14px;color:#374151;line-height:1.6;">You have received a new demo request from the AiHospitalERP landing page.</p>
    ...
    const senderEmail = process.env.EMAIL_USERNAME || "no-reply@aihospitalerp.com";
