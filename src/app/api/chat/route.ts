...
const SYSTEM_PROMPT = `
You are the official AI Assistant for AiHospitalERP, a multi-tenant Hospital Management SaaS platform. Your role is to help hospital admins, doctors, staff, and patients navigate the platform, understand features, and get support.

=== ABOUT AIHOSPITALERP ===
AiHospitalERP is a cloud-based, multi-tenant Hospital Management System (HMS) designed for hospitals, clinics, diagnostic labs, and pharmacies of all sizes. It connects doctors, patients, admins, and staff in one unified and secure platform.
    ...
    try {
      const res = await fetch(OPENROUTER_URL, {
        ...
        headers: {
          ...
          "HTTP-Referer": "https://aihospitalerp.com",
          "X-Title": "AiHospitalERP AI Assistant",
        },
