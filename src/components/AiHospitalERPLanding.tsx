...
import {
  ...
  Calendar, BedDouble, Receipt, ShieldCheck, Mail, Phone, MapPin
} from "lucide-react";
...
export default function AiHospitalERPLanding() {
  ...
  const faqs = [
    { q: "What is AiHospitalERP and who is it for?", a: "AiHospitalERP is a multi-tenant Hospital Management SaaS platform designed for hospitals, clinics, diagnostic labs, and pharmacies of any size. It connects doctors, patients, admins, and staff in one unified platform." },
    ...
    { q: "Is patient data secure and isolated per hospital?", a: "Absolutely. AiHospitalERP enforces strict multi-tenant data isolation — each hospital's data is completely separate. We use encrypted storage, secure JWT authentication, and role-based access control." },
    ...
    { q: "Does AiHospitalERP support billing and pharmacy management?", a: "Yes — billing, pharmacy inventory, counter sales, IPD/OPD billing, lab reports, and finance dashboards are all built-in. No third-party integrations needed." },
  ...
  const testimonials = [
    { name: "Dr. Priya Sharma", role: "Cardiologist, Apollo Hospitals", avatar: "PS", rating: 5, text: "AiHospitalERP transformed how we manage patient flow. The appointment system and billing module saved us hours every day. Our staff productivity increased by 40%." },
    ...
    <>
      <style dangerouslySetInnerHTML={{
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .mn-trusted { padding: 32px 0; background: linear-gradient(90deg, ${PURPLE_50} 0%, #fff 50%, ${PURPLE_50} 100%); border-top: 1px solid #f1f5f9; border-bottom: 1px solid #f1f5f9; overflow: hidden; }
        .mn-tracked-marquee { display: flex; animation: marqueeScroll 30s linear infinite; gap: 48px; }
        .mn-tracked-marquee:hover { animation-play-state: paused; }
        @keyframes marqueeScroll { 0% { transform: translateX(0); } 100% { transform: translateX(-50%); } }
        .mn-feature-item { display: flex; align-items: center; gap: 10px; flex-shrink: 0; padding: 10px 24px; background: #fff; border-radius: 999px; box-shadow: 0 2px 12px rgba(124,58,237,0.08); border: 1px solid rgba(124,58,237,0.1); }
        .mn-feature-item svg { color: ${PURPLE}; }
        .mn-feature-item span { font-size: 13px; font-weight: 600; color: ${DARK}; white-space: nowrap; }
...
.mn-testi-role { font-size: 12px; color: ${GRAY}; }
        ...
        @media (max-width: 640px) {
          ...
          .mn-footer-contact a, .mn-footer-contact-item { font-size: 12.5px; }
          .mn-footer-copy { font-size: 11.5px; }
          .mn-trusted { padding: 24px 0; }
          .mn-feature-item { padding: 8px 16px; gap: 8px; }
          .mn-feature-item span { font-size: 11px; }
        ...
        @media (max-width: 420px) {
          ...
          .mn-footer-contact { gap: 10px; }
          .mn-footer-contact a, .mn-footer-contact-item { font-size: 12px; }
          .mn-footer-copy { font-size: 10.5px; }
          .mn-trusted { padding: 16px 0; }
          .mn-feature-item { padding: 6px 12px; gap: 6px; }
          .mn-feature-item span { font-size: 10px; }
            ...
            <div className="mn-hero-dash-window">
              ...
              <div className="mn-dash-topbar">
                <div className="mn-dash-topbar-logo">
                  <img src="/logo/aihospitalerp-logo.png" alt="AiHospitalERP" style={{ height: 28, width: "auto", objectFit: "contain" }} />
                </div>
      ...
      <section className="mn-trusted">
        <div className="mn-tracked-marquee">
          {[
            { icon: Calendar, label: "Smart Appointments" },
            { icon: Users, label: "Patient Management" },
            { icon: Stethoscope, label: "Doctor Dashboard" },
            { icon: Pill, label: "Pharmacy Module" },
            { icon: FlaskConical, label: "Lab & Pathology" },
            { icon: BedDouble, label: "IPD Management" },
            { icon: Receipt, label: "Billing & Invoicing" },
            { icon: BarChart3, label: "Real-time Analytics" },
            { icon: ShieldCheck, label: "Role-based Access" },
            { icon: Bell, label: "Smart Notifications" },
            { icon: Brain, label: "AI Prescription" },
            { icon: Mic, label: "Voice Dictation" },
          ].map((f, i) => (
            <div key={i} className="mn-feature-item">
              <f.icon size={18} />
              <span>{f.label}</span>
            </div>
          ))}
          ...
          {[
            ...
            <div key={i + 12} className="mn-feature-item">
              <f.icon size={18} />
              <span>{f.label}</span>
            </div>
          ))}
            ...
            <div className="mn-ai-body">
              ...
              <div className="mn-ai-info">
                ...
                <p className="mn-ai-info-p">
                  AiHospitalERP analyses patient history, vitals, and diagnosis in real-time to auto-generate accurate prescriptions — reducing the doctor&apos;s writing load by up to 80% while maintaining clinical precision.
                </p>
              ...
              <div className="mn-ai-mock">
                <div className="mn-ai-mock-topbar">
                  ...
                  <div className="mn-ai-mock-title">AiHospitalERP · Smart Prescription</div>
          ...
          {aiTab === "voice" && (
            <div className="mn-ai-body">
              ...
              <div className="mn-ai-info">
                ...
                <p className="mn-ai-info-p">
                  Doctors dictate prescriptions naturally — just like talking to a colleague. AiHospitalERP transcribes speech in real-time, extracts medicines, dosage & instructions, and structures a complete digital Rx without typing a single character.
                </p>
              ...
              <div className="mn-ai-mock voice-mock">
                <div className="mn-ai-mock-topbar">
                  ...
                  <div className="mn-ai-mock-dot" style={{ background: "#FEBC2E" }} />
                  <div className="mn-ai-mock-dot" style={{ background: "#28C840" }} />
                  <div className="mn-ai-mock-title">AiHospitalERP · Voice Prescription</div>
      ...
      <section className="mn-testi">
        <div className="mn-testi-inner">
          ...
          <p className="mn-section-sub" style={{ margin: "0 auto 0" }}>See what healthcare professionals say about managing their hospitals with AiHospitalERP.</p>
      ...
      <section className="mn-faq" id="faq">
        <div className="mn-faq-inner">
          ...
          <p className="mn-section-sub" style={{ margin: "0 auto 0" }}>Everything you need to know about AiHospitalERP.</p>
          ...
          <div className="mn-footer-top">
            ...
            <div>
              ...
              <div className="mn-footer-links">
                ...
                <a href="#features">Patient Management</a>
                <a href="#features">Revenue Tracking</a>
                <a href="#features">Doctor Portal</a>
                <a href="#features">Analytics Dashboard</a>
                <a href="#features">Multi-Clinic Support</a>
              </div>
            </div>
        ...
        <div className="mn-demo-modal" onClick={e => e.stopPropagation()}>
          ...
          {demoSuccess ? (
            ...
            <>
              ...
              <p>See how AiHospitalERP can transform your hospital's operations. Fill out the form below and our experts will reach out to confirm your slot.</p>
