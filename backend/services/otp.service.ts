  ...
  <tr><td align="center">
    <table width="500" cellpadding="0" cellspacing="0" style="max-width:500px;width:100%;background:#ffffff;border-radius:12px;border:1px solid #e5e7eb;overflow:hidden;">
      ...
      <tr>
        <td style="padding:32px 40px 24px;border-bottom:1px solid #f3f4f6;">
          <p style="margin:0 0 2px;font-size:12px;font-weight:600;color:#9ca3af;letter-spacing:0.08em;text-transform:uppercase;">AiHospitalERP</p>
      ...
      <tr>
        <td style="padding:32px 40px 24px;">
          <p style="margin:0 0 24px;font-size:14px;color:#6b7280;line-height:1.65;">
            Use the one-time code below to complete your hospital registration on AiHospitalERP.
      ...
      <tr>
        <td style="padding:16px 40px 24px;border-top:1px solid #f3f4f6;text-align:center;">
          <p style="margin:0;font-size:11px;color:#d1d5db;">
            &copy; ${year} AiHospitalERP &middot; Automated message &mdash; please do not reply.
          </p>
        </td>
      </tr>
    ...
    await transporter.sendMail({
      from: Object.is(env.EMAIL_USERNAME, "")
        ? '"AiHospitalERP" <no-reply@aihospitalerp.com>'
        : `"AiHospitalERP" <${env.EMAIL_USERNAME}>`,
      to: email,
      subject: "Your Verification Code – AiHospitalERP",
